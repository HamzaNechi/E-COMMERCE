...
<div class="row">
    ...
    <div class="col-4"></div>
    <div class="col-4">
      <form method="get" action="{{ url('/Rechercher_commande_date')}}">
        <div class="form-group">
          <div class="input-group">
            <input type="text" class="form-control form-control-sm" placeholder="Chercher une commande par date" aria-label="Recipient's username" aria-describedby="basic-addon2" name="recherche">
