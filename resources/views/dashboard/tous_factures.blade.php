...
<div class="row">
  ...
  <div class="col-lg-4">
      ...
      @if(Auth::user()->role != 2)
      <form method="get" action="{{ url('/Rechercher_facture')}}">
      ...
      @if(Auth::user()->role == 2)
      <form method="get" action="{{ url('/RechercherParDate')}}">
        <div class="form-group">
          <div class="input-group">
            <input type="text" class="form-control form-control-sm" placeholder="Chercher une facture par date" aria-label="Recipient's username" aria-describedby="basic-addon2" name="recherche">
            <div class="input-group-append">
              <button class="btn btn-sm btn-gradient-primary" type="button"><i class="mdi mdi-magnify"></i></button>
            </div>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      ...
                      <td>
                        ...
                        @if($row->methode == "Livraison")
                        <label class="badge badge-info">{{ $row->methode }}</label>
                        @endif
                      </td>
                      <td>
                        {{ $row->total_ttc }} TND
                      ...
                      <td>
                        ...
                        @if($row->net == 0 && $row->methode=="Par tranche")
                      ...
                      <td>
                          ...
                          <a href="{{ url('/Facture',$row->id_commande)}}"><button type="button" class="btn btn-warning btn-rounded btn-icon" title="Voir facture">
                            <i class="mdi mdi-eye"></i>
                          </button></a>

                       @if(Auth::user()->role != 2) 
                        <a href="{{ url('/ModifierFacture',$row->id)}}">
