              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <button type="button" class="btn btn-success btn-rounded btn-icon" alt="Sous catégorie" title="Voir sous catégorie">
                    ...
                    {{ $categorie->links('vendor.pagination.dashboard-paginator') }}
                  </div>
                </div>
              </div>
            </div>
