...
<div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <td> {{ $row->qty }} </td>
                          <td> {{ $row->prix_venteHT }} </td>
                          <td>{{ $row->montant_ttc }} </td>
                          <td>
                            
                           
                              <a href="{{ url('/Supprimer/Produit/Facture',$row->id)}}">
                    ...
                    <form action="{{ url('/AjouterProduitFacture')}}" method="post" id="addproductForm">
                        {{ csrf_field() }}
                    ...
                    <form id="addFactureForm" class="form-sample" method="post" action="{{ url('/Personnaliser/Facture')}}">
                      {{ csrf_field() }}
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="timbre" placeholder="Timbre" name="timbre" value="" disabled>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
