...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Modifier code promo.</h4>
              <p class="card-description"> Horizontal form layout </p>
              
                    <form class="forms-sample" method="POST" action="{{ url('/Modifier_code',$getCode->id)}}" enctype="multipart/form-data">
                      {{ csrf_field() }}

                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Code</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Code promo" name="coupon_code" value="{{ $getCode['coupon_code'] }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputEmail2" name="montant" placeholder="Montant" value="{{ $getCode['montant'] }}" >
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <select class="form-control" id="exampleSelectGender" value="{{ $getCode['montant_type'] }}"  name="type">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="date" class="form-control" name="date" placeholder="dd/mm/yyyy" value="{{ $getCode['date_expiration'] }}">
                        </div>
