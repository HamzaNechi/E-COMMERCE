...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form enctype="multipart/form-data" id="editArticleForm" class="form-sample" method="post" action="{{ url('/modifier-article/'.$article->id)}}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="exampleInputCity1">Titre</label>
                            <input type="text" class="form-control" name="title" placeholder="Titre de l'article" value="{{$article->title}}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="author" placeholder="Auteur" value="{{$article->author}}">
                            </div>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="quote" placeholder="Ajouter une citation si tu veut" value="{{$article->quote}}">
                            </div>
                        </div>
                    </div>
                </div>
                <!-- <a type="submit" class="btn btn-gradient-primary mr-2">Ajouter</button> -->
                <a class="btn btn-gradient-primary mr-2" href="javascript:{}" onclick="document.getElementById('content').value=document.getElementsByClassName('note-editable')[0].innerHTML;document.getElementById('submit').click();">Enregistrer</a>
